...
public class ModuleManager implements IManager {
    ...
    public static StrafeV2 strafeV2 = new StrafeV2();
    public static InstantCrossbow instantCrossbow = new InstantCrossbow();
    ...
    public static PacketTeleport packetTeleport = new PacketTeleport();
    ...
    public static SpinBot spinBot = new SpinBot();
