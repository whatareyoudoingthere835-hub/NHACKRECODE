...
public class ColorPickerElement extends AbstractElement {
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        FontRenderers.sf_medium_mini.drawString(Draw2D.CURRENT.getMatrices(), setting.getName(), x + 6, y + 8, new Color(-1).getRGB());
        ...
        FontRenderers.sf_medium_mini.drawString(Draw2D.CURRENT.getMatrices(), "Сopy", x + 13, y + 56.5f, copyHovered ? new Color(0xA3FFFFFF, true).getRGB() : Color.WHITE.getRGB());
        ...
        FontRenderers.sf_medium_mini.drawString(Draw2D.CURRENT.getMatrices(), "RB", x + 44f, y + 56.5f, rainbowHovered ? new Color(0xA3FFFFFF, true).getRGB() : (dark2 ? Color.WHITE.getRGB() : Color.BLACK.getRGB()));

        Render2DEngine.drawRect(matrixStack, x + 63f, y + 54f, 24, 7, ThunderHack.copy_color);
        FontRenderers.sf_medium_mini.drawString(Draw2D.CURRENT.getMatrices(), "Paste", x + 67f, y + 56.5f, pasteHovered ? new Color(0xA3FFFFFF, true).getRGB() : dark ? Color.WHITE.getRGB() : Color.BLACK.getRGB());
