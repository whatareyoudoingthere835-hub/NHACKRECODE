...
public class LagNotifier extends Module {
    ...
    public void onRender2D(DrawContext context) {
        ...
        if (packetTimer.passedMs(responseTreshold.getValue() * 1000L) && serverResponseNotify.getValue()) {
            ...
            context.drawTexture(RenderPipelines.GUI_TEXTURED, TextureStorage.lagIcon, (int) ((float) mc.getWindow().getScaledWidth() / 2f - 40), (int) ((float) mc.getWindow().getScaledHeight() / 3f - 120), 0, 0, 80, 80, 80, 80, -1);
